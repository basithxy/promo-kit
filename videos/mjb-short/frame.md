...
colors:
  ...
  text-muted: "#99A1AF"
  text-light: "#656565"
  accent-light: "rgba(124, 46, 255, 0.08)"
  accent-medium: "rgba(124, 46, 255, 0.15)"
  border: "rgba(124, 46, 255, 0.2)"
  card-bg: "rgba(124, 46, 255, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Inter** (display) / **Inter Tight** (body); ignore any preset font name lingering in prose.
