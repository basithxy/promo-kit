...
description: >
  ...
  accent, the three-step gray text ladder, Poppins (display/numerals/chrome) + Poppins (body),
...
colors:
  ...
  text-muted: "#4046B3"
  text-light: "#9A9A9A"
  accent-light: "rgba(23, 25, 64, 0.08)"
  accent-medium: "rgba(23, 25, 64, 0.15)"
  border: "rgba(23, 25, 64, 0.2)"
  card-bg: "rgba(23, 25, 64, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Poppins body + Poppins chrome) —
  body:    { fontFamily: "Poppins", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Poppins", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Poppins", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Poppins", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Poppins, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Poppins", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Poppins", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Poppins", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Poppins", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Poppins", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Poppins", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Poppins", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **Poppins** (display) / **revicons** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **Poppins** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Poppins** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Poppins** (display/numerals/chrome) + **Poppins** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Poppins body 0.85cqw muted; Poppins eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Poppins `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Poppins 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Poppins `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Poppins label + muted desc + optional
...
blockquote, cite. **Focal** a Poppins `blockquote` near-black under a 15%-opacity cobalt
...
Poppins body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Poppins `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Poppins 400 muted, line 1.6.
...
- **Type** — Poppins headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Poppins body muted line 1.6; ≥1.4cqw floor.
...
- **Poppins + Poppins via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
