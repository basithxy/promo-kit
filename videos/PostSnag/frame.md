...
colors:
  ...
  text-muted: "#0A1535"
  text-light: "#9A9A9A"
  accent-light: "rgba(35, 57, 135, 0.08)"
  accent-medium: "rgba(35, 57, 135, 0.15)"
  border: "rgba(35, 57, 135, 0.2)"
  card-bg: "rgba(35, 57, 135, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Mona Sans body + chrome — see "Font substitution" note below) —
  body:    { fontFamily: "Mona Sans", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Mona Sans", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Mona Sans", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Mona Sans", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Mona Sans, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Mona Sans", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Mona Sans", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Mona Sans", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Mona Sans", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Mona Sans", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Mona Sans", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Mona Sans", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts — substitution note.** The captured site's primary font (Geist) ships only as opaque content-hashed font files with no reliable family mapping in this capture; only **Mona Sans** (400 + 500 weight files) is positively identifiable in `assets/fonts/`. The frontmatter above is therefore set to **Mona Sans** for every role (display + body + chrome) — ignore any "Geist" mentioned in the prose below, it is stale. Use ONLY `Mona Sans` with a real `@font-face` (see "Font loading" at the end of this file); do not name "Geist" in any composition — it has no matching font file in this project.
- **Weights** — only the 400 (Regular) Mona Sans file is staged in `assets/fonts/`; every heavier role (500/600/700/800 — tag, counter, h3, h4-eyebrow, h2, stat-num, metric-value, h1, quote-mark) renders as browser-synthesized bold from that one file — expected and acceptable, not a lint issue.
...
```html
<style>
@font-face{font-family:"Mona Sans";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/MonaSans-Regular.woff") format("woff");}
