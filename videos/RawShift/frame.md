...
typography:
  ...
  body:    { fontFamily: "__Inter_f367f3", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "__Inter_f367f3", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "__Inter_f367f3", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "__Inter_f367f3", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (__Inter_f367f3, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "__Inter_f367f3", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "__Inter_f367f3", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "__Inter_f367f3", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "__Inter_f367f3", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
...
- **Fonts** — already set to **__Inter_f367f3** (display) / **__Inter_f367f3** (body); ignore any preset font name lingering in prose.
...
```html
<style>
@font-face{font-family:"__Inter_f367f3";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/Interf367f3-Regular.woff2") format("woff2");}
</style>
```
