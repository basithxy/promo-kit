...
description: >
  ...
  everything, the sun-bleached cream canvas, the nine-color candy palette, Montserrat + Space
...
typography:
  # — reading ramp (Montserrat) —
  body:      { fontFamily: "Montserrat", cqw: 0.85, weight: 400, lineHeight: 1.6 }
  subtitle:  { fontFamily: "Montserrat", cqw: 0.95, weight: 400, tracking: "0.18em", upper: true }
  pill-text: { fontFamily: "Montserrat", cqw: 0.75, weight: 600, tracking: "0.12em", upper: true }
  label:     { fontFamily: "Montserrat", px: 14, weight: 500, tracking: "0.1em", upper: true }
  # — display / hero ramp (Montserrat, ink, sentence case) —
  card-headline:{ fontFamily: "Montserrat", cqw: 1.9, weight: 700, lineHeight: 1.1 }
  orbit-numeral:{ fontFamily: "Montserrat", cqw: 2.6, weight: 700, lineHeight: 1.0 }
  quote-display:{ fontFamily: "Montserrat", cqw: 4.2, weight: 600, lineHeight: 1.3, tracking: "-0.01em" }
  stat-number: { fontFamily: "Montserrat", cqw: 3.6, weight: 800, lineHeight: 1.0, tracking: "-0.03em" }
  section-headline:{ fontFamily: "Montserrat", cqw: 4.0, weight: 700, lineHeight: 1.05, tracking: "-0.01em" }
  headline:    { fontFamily: "Montserrat", cqw: 5.0, weight: 700, lineHeight: 1.05, tracking: "-0.02em" }
  closing-display:{ fontFamily: "Montserrat", cqw: 8.5, weight: 800, lineHeight: 0.95, tracking: "-0.03em" }
  display:     { fontFamily: "Montserrat", cqw: 12.0, weight: 800, lineHeight: 0.88, tracking: "-0.03em" }
...
components:
  ...
  pill-card:
    ...
    description: "Holds a circular card-icon, Bodoni headline, Montserrat body."
  stat-pill:
    backgroundColor: "{colors.white}"
    border: "0.2cqw solid {colors.outline}"
    rounded: "2rem"
...
- **Fonts** — already set to **Montserrat** (display) / **star** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{100, 300, 400, 500, 600, 700, 800}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
The voice is a two-face conversation: **Montserrat** (didone serif, weight 700–800, always ink,
always sentence case) carries every headline, stat, and quote; **Montserrat** carries body and
...
- **Montserrat** display (ink, sentence case) + **Montserrat** body/pills (uppercase, tracked).
...
Two ramps. The **reading ramp** (Montserrat body 0.85cqw, uppercase tracked pill/label text)
...
- **Bodoni 700+ in ink, sentence case** (italic via `<em>` only, color allowed on the italic key word as a candy hue); **Montserrat pills/labels uppercase, 0.08em+ tracked**; negative-track Bodoni display.
...
- **Montserrat + Montserrat via Google Fonts.** CJK pairing (ZCOOL XiaoWei / Yozai) carries over from the source.
...
```html
<style>
@font-face{font-family:"Montserrat";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/Montserrat-Regular.otf") format("opentype");}
@font-face{font-family:"WooCommerce";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/WooCommerce-Regular.ttf") format("truetype");}
@font-face{font-family:"WooCommerce";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/WooCommerce-Regular.woff") format("woff");}
@font-face{font-family:"WooCommerce";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/WooCommerce-Regular.woff2") format("woff2");}
@font-face{font-family:"Open Sans";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/OpenSans-Regular.woff2") format("woff2");}
</style>
```
