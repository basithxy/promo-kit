...
description: >
  ...
  accent, the three-step gray text ladder, __Inter_f367f3 (display/numerals/chrome) + __Inter_f367f3 (body),
...
colors:
  ...
  text-muted: "#6B6B6B"
  text-light: "#9A9A9A"
  accent-light: "rgba(5, 101, 245, 0.08)"
  accent-medium: "rgba(5, 101, 245, 0.15)"
  border: "rgba(5, 101, 245, 0.2)"
  card-bg: "rgba(5, 101, 245, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (__Inter_f367f3 body + __Inter_f367f3 chrome) —
  body:    { fontFamily: "__Inter_f367f3", cqw: 0.85, weight: 700, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "__Inter_f367f3", cqw: 0.8, weight: 700, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "__Inter_f367f3", px: 12, weight: 700, color: "primary" }
  counter: { fontFamily: "__Inter_f367f3", px: 13, weight: 700, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (__Inter_f367f3, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "__Inter_f367f3", cqw: 1.25, weight: 700, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "__Inter_f367f3", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "__Inter_f367f3", cqw: 2.4, weight: 700, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "__Inter_f367f3", cqw: 2.6, weight: 700, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "__Inter_f367f3", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "__Inter_f367f3", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "__Inter_f367f3", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **__Inter_f367f3** (display) / **Nohemi** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{700}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
The voice is two faces in fixed roles: **__Inter_f367f3** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **__Inter_f367f3** (body, muted gray, line 1.6). Headlines are near-black;
...
- **__Inter_f367f3** (display/numerals/chrome) + **__Inter_f367f3** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (__Inter_f367f3 body 0.85cqw muted; __Inter_f367f3 eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (__Inter_f367f3 `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body __Inter_f367f3 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line __Inter_f367f3 `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + __Inter_f367f3 label + muted desc + optional
...
blockquote, cite. **Focal** a __Inter_f367f3 `blockquote` near-black under a 15%-opacity cobalt
...
__Inter_f367f3 body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a __Inter_f367f3 `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body __Inter_f367f3 400 muted, line 1.6.
...
- **Type** — __Inter_f367f3 headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; __Inter_f367f3 body muted line 1.6; ≥1.4cqw floor.
...
- **__Inter_f367f3 + __Inter_f367f3 via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
...
```html
<style>
@font-face{font-family:"Nohemi";font-weight:700;font-style:normal;font-display:block;src:url("assets/fonts/Nohemi-Bold.otf") format("opentype");}
</style>
```
